...
.fl-node-<?php echo $id; ?> .mediaron-restaurant-menu-item {
	display: flex;
}
@media only screen and (max-width: 768px) {

}
.fl-node-<?php echo $id; ?> .mediaron-restaurant-menu-item .menu-item-text-wrapper {
	flex-grow: 2;
	padding-left: 20px;
}
.fl-node-<?php echo $id; ?> .mediaron-restaurant-menu-item .menu-item-text-wrapper.no-photo {
	flex-grow: 3;
	padding: 0;
}

.fl-node-<?php echo $id; ?> .mediaron-restaurant-menu-item .menu-item-price {
	flex-grow: 2;
	text-align: right;
}
