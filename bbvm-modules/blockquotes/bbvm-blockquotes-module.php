...
class BBVapor_Blockquotes_Module extends FLBuilderModule {
	public function __construct()
	{
		parent::__construct(array(
			'name'            => __( 'Blockquote', 'bb-vapor-modules-pro' ),
			'description'     => __( 'Add a Blockquote', 'bb-vapor-modules-pro' ),
			'category'        => __( 'Base', 'bb-vapor-modules-pro' ),
			'group'           => __( 'MediaRon Modules', 'bb-vapor-modules-pro' ),
			'dir'             => BBVAPOR_PRO_BEAVER_BUILDER_DIR . 'bbvm-modules/blockquotes/',
			'url'             => BBVAPOR_PRO_BEAVER_BUILDER_URL . 'bbvm-modules/blockquotes/',
 ...
 */
FLBuilder::register_module('BBVapor_Blockquotes_Module', array(
	'general'       => array( // Tab
