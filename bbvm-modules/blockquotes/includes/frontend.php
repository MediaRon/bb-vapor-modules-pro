...
<div class="blockquote">
	<h2><?php echo $settings->blockquote_text; ?></h2>
	<h3><?php echo $settings->blockquote_attribution; ?></h3>
</div>
<?php
endif;
...
if( 'cite' === $settings->blockquote_style ) :
	?>
	<blockquote>
		<p><?php echo $settings->blockquote_text; ?></p>
		<cite><?php echo $settings->blockquote_attribution; ?></cite>
	</blockquote>
<?php
endif;
