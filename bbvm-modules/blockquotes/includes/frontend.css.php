...
if( 6 === strlen( $bold_background_color ) ) {
...
.fl-node-<?php echo $id; ?> .blockquote h2 {
	color: #224841;
	position: relative;
	font-family: '<?php echo $settings->font_heading['family']; ?>';
	font-weight: <?php echo $settings->font_heading['weight']; ?>;
	font-size: 2.5rem;
	font-weight: normal;
	line-height: 0.8;
	margin: 0;
...
.fl-node-<?php echo $id; ?> .blockquote h2:after {
	content:"’";
	position: absolute;
	top: -3rem;
	...
	font-size: 100rem;
	line-height: 0.7;
	color: <?php echo $settings->bold_quote_color; ?>;
	text-shadow: -3rem -3rem 0 <?php $settings->text_shadow_color; ?>;
	z-index: -1;
}
.fl-node-<?php echo $id; ?> .blockquote h2:before {
	content:"’";
	position: absolute;
	font-family: sans-serif;
	top: 0;
...
.fl-node-<?php echo $id; ?> .blockquote h3 {
	position: relative;
	color: #224841;
	font-size: 1.5rem;
	font-family: '<?php echo $settings->font_attribution['family']; ?>';
	font-weight: <?php echo $settings->font_attribution['weight']; ?>;
	line-height: 1.1;
	margin: 0;
	padding-top: 1.5rem;
	z-index: 1;
...
.fl-node-<?php echo $id; ?> .blockquote {
	...
	margin: 80px auto;
	align-self: center;
	border-top: solid 1px <?php echo $enhanced_border_color; ?>;
	border-bottom: solid 1px <?php echo $enhanced_border_color; ?>;
	background-color: <?php echo $enhanced_background_color; ?>;
}
.fl-node-<?php echo $id; ?> .blockquote h2 {
	font-family: '<?php echo $settings->font_heading['family']; ?>';
	font-weight: <?php echo $settings->font_heading['weight']; ?>;
	position: relative;
    color: <?php echo $enhanced_text_color; ?>;
    font-size: 40px;
    font-weight: 800;
    margin: 0;
}
.fl-node-<?php echo $id; ?> .blockquote:after {
    position: absolute;
    content: "”";
    color: <?php echo $enhanced_quote_color; ?>;
    font-size: 10rem;
    line-height: 0;
    bottom: -43px;
    right: 30px;
...
if( 'top_bottom_border' === $settings->blockquote_style ):
	...
	if( 6 === strlen( $border_color_hover ) ) {
...
.fl-node-<?php echo $id; ?> .blockquote:hover:before {
	background-color: <?php echo $border_color_hover; ?>;
}
.fl-node-<?php echo $id; ?> .blockquote:hover:after {
	background-color: <?php echo $border_color_hover; ?>;
}
.fl-node-<?php echo $id; ?> .blockquote h2 {
	font-family: '<?php echo $settings->font_heading['family']; ?>';
...
.fl-node-<?php echo $id; ?> blockquote p {
	font-family: '<?php echo $settings->font_heading['family']; ?>';
	font-weight: <?php echo $settings->font_heading['weight']; ?>;
	position: relative;
    color: <?php echo $text_color; ?>;
...
.fl-node-<?php echo $id; ?> blockquote cite {
	display: block;
	position: relative;
    color: <?php echo $text_color; ?>;
    font-size: 1.4rem;
...
if( 'cite_animated_border' === $settings->blockquote_style ):
	...
	if( 6 === strlen( $border_color_animated ) ) {
...
.fl-node-<?php echo $id; ?> blockquote {
	...
	color: <?php echo $text_color; ?>;
	padding: 50px 50px;
	border: solid 1em <?php echo $border_color; ?>;
	width: 100%;
	max-width: 500px;
	z-index: 1;
	margin: 0 auto;
...
.fl-node-<?php echo $id; ?> blockquote:before {
	...
	bottom: 0;
	left: 0;
	background: linear-gradient(0deg, <?php echo $border_color; ?> calc(50% - 1em), transparent calc(50% - 1em)), linear-gradient(180deg, <?php echo $border_color; ?> calc(50% - 1em), transparent calc(50% - 1em));
	width: 4px;
}
.fl-node-<?php echo $id; ?> blockquote:after {
	content: "“";
...
if( 'background_quotes' === $settings->blockquote_style ):
	...
	if( 6 === strlen( $background_quote_color ) ) {
...
.fl-node-<?php echo $id; ?> blockquote:before {
	z-index: -1;
	position: absolute;
	color: <?php echo $background_quote_color; ?>;
	font-size: 4rem;
	font-style: normal;
	font-weight: 700;
	content: "“";
