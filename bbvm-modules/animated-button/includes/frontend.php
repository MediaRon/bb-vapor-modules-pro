...
<a class="fl-bbvm-animated-button-for-beaverbuilder bbvm-button <?php echo esc_attr( $classes ); ?>" id="<?php echo esc_attr( $settings->button_id ); ?>" href="<?php echo esc_url( $settings->button_link ); ?>"><span><?php echo ! empty( $settings->button_icon ) && 'before' === $settings->button_icon_location ? sprintf( '<i class="%s hvr-icon" /></i>&nbsp;', esc_attr( $settings->button_icon ) ) : ''; ?><?php echo esc_html( $settings->button_text ); ?><?php echo ! empty( $settings->button_icon ) && 'after' === $settings->button_icon_location ? sprintf( '&nbsp;<i class="%s hvr-icon" /></i>', esc_attr( $settings->button_icon ) ) : ''; ?></span></a>
</div>
