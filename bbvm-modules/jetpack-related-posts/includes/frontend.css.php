...
?>
.fl-node-<?php echo $id; ?> .jp-relatedposts-wrapper.grid {
	display: flex;
	flex-wrap: wrap;
	justify-content: flex-start;
}
.fl-node-<?php echo $id; ?> .jp-relatedposts-items {
	box-sizing: border-box;
	padding: 10px;
}
.fl-node-<?php echo $id; ?> .jp-relatedposts-wrapper .columns-1 {
	width: 100%;
}
.fl-node-<?php echo $id; ?> .jp-relatedposts-wrapper .columns-2 {
  width: 50%;
}
...
.fl-node-<?php echo $id; ?> .jp-relatedposts-wrapper .columns-3 {
  width: 33%;
}
...
.fl-node-<?php echo $id; ?> .jp-relatedposts-wrapper .columns-4 {
  width: 25%;
}
...
.fl-node-<?php echo $id; ?> .jp-relatedposts-wrapper .columns-5 {
  width: 20%;
}
...
.fl-node-<?php echo $id; ?> .jp-relatedposts-wrapper .columns-6 {
  width: 16%;
}
@media only screen and (max-width: 1000px) {
	.fl-node-<?php echo $id; ?> .jp-relatedposts-wrapper .columns-6 {
...
.fl-node-<?php echo $id; ?> .jp-relatedposts-wrapper.list img {
	float: left;
	overflow: hidden;
	max-width: 33%;
	margin-right: 3%;
...
.fl-node-<?php echo $id; ?> #jp-relatedposts .jp-relatedposts-list h4.jp-relatedposts-post-title {
	display: inline-block;
    max-width: 63%;
}
<?php endif; ?>
