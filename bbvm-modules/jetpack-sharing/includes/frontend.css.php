...
if( 6 === strlen( $button_background_color_hover ) ) {
	$button_background_color_hover = '#' . $button_background_color_hover;
}
...
if( 6 === strlen( $sharing_headline_color ) ) {
