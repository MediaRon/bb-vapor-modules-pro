...
class BBVapor_Restaurant_Menu_Item_Module extends FLBuilderModule {
	public function __construct()
	{
		...
		$this->add_js('mediaron-restaurant-items-for-beaver-builder', BBVAPOR_PRO_BEAVER_BUILDER_URL . 'bbvm-modules/restaurant-menu-items/js/frontend.js', array( 'jquery', 'jquery-magnificpopup' ), BBVAPOR_PRO_BEAVER_BUILDER_VERSION );
	}
}
/**
