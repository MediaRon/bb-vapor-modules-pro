...
class BBVapor_LearnDash_Quizzes extends FLBuilderModule {
	...
	public function __construct() {
		parent::__construct(
			array(
				'name'            => __( 'LearnDash Quizzes', 'bb-vapor-modules-pro' ),
				'description'     => __( 'LearnDash Quizzes', 'bb-vapor-modules-pro' ),
				'category'        => __( 'LearnDash', 'bb-vapor-modules-pro' ),
				'group'           => apply_filters( 'bbvm_whitelabel_category', __( 'Vapor', 'bb-vapor-modules-pro' ) ),
				'dir'             => BBVAPOR_PRO_BEAVER_BUILDER_DIR . '/bbvm-modules/learndash-quizzes/',
				'url'             => BBVAPOR_PRO_BEAVER_BUILDER_URL . 'bbvm-modules/learndash-quizzes/',
			...
			'sections' => array(
				'container' => array(
					...
					'fields' => array(
						'user_courses' => array(
							'type'    => 'select',
							'label'   => __( 'Show User Quizzes Only', 'bb-vapor-modules-pro' ),
							'default' => 'false',
							'options' => array(
			...
			'sections' => array(
				...
				'colors' => array(
					...
					'fields' => array(
						...
						'course_price_heading'   => array(
							'type'       => 'color',
							'label'      => __( 'Quiz Heading Color', 'bb-vapor-modules-pro' ),
							'show_alpha' => true,
							'show_reset' => true,
						),
					),
