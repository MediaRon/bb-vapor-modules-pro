...
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> input[type=email],
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> input[type=tel],
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> input[type=date],
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> input[type=month],
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> input[type=week],
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> input[type=time],
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> input[type=number],
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> input[type=search],
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> input[type=url],
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> textarea {
	display: block;
	padding: 15px;
...
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> select {
...
if ( 'full_width_centered' === $settings->layout ) :
	...
	.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> input[type=search],
	.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> input[type=url],
	.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> input[type=submit],
	.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> input[type=button],
	.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> textarea,
	.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .ginput_container span,
	.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .gfinput_container span label,
	.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .gfield_label,
	.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> input[type=text]::placeholder,
	.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> input[type=password]::placeholder,
	.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> input[type=email]::placeholder,
	.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> input[type=tel]::placeholder,
	.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> input[type=date]::placeholder,
	.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> input[type=month]::placeholder,
	.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> input[type=week]::placeholder,
	.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> input[type=time]::placeholder,
	.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> input[type=number]::placeholder,
	.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> input[type=search]::placeholder,
	.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> input[type=url]::placeholder,
	.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> textarea::placeholder,
	.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .ginput_container span::placeholder,
	.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .gfinput_container span label::placeholder {
		display: inline-block;
		width: 100%;
		text-align: center !important;
		text-align-last: center !important;
	}
	.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> input[type=button], .fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> input[type=submit], .fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> button {
		text-align: center;
		margin: 0 auto;
	}
	.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> span.gfield_required {
		display: inline;
		width: 10px;
		}
		<?php
...
?>
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> span label {
	color: <?php echo esc_html( BBVapor_Modules_Pro::get_color( $settings->form_sub_label_color ) ); ?>;
}
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .gfield_label {
	color: <?php echo esc_html( BBVapor_Modules_Pro::get_color( $settings->form_label_color ) ); ?>;
}
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> input[type=text],
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> input[type=password],
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> input[type=email],
...
if ( ! empty( $settings->progress_title_show ) && 'no' === $settings->progress_title_show ) :
	?>
	.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .gf_progressbar_wrapper h3.gf_progressbar_title {
		display: none;
	}
	<?php
endif;
if ( ! empty( $settings->progress_title_color ) ) :
	?>
	.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .gf_progressbar_wrapper h3.gf_progressbar_title {
		color: <?php echo esc_html( BBVapor_Modules_Pro::get_color( $settings->progress_title_color ) ); ?>;
	}
	<?php
endif;
...
if ( isset( $settings->progress_bar_outer_border_radius ) ) :
	...
	.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .gf_progressbar_wrapper .gf_progressbar_percentage:after {
		border-radius: <?php echo absint( $settings->progress_bar_outer_border_radius ); ?>px;
		-moz-border-radius: <?php echo absint( $settings->progress_bar_outer_border_radius ); ?>px;
		-webkit-border-radius: <?php echo absint( $settings->progress_bar_outer_border_radius ); ?>px;
	}
...
if ( ! empty( $settings->progress_bar_inner_color ) ) :
	...
	.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .gf_progressbar_wrapper .gf_progressbar_percentage {
		background-color: <?php echo esc_html( BBVapor_Modules_Pro::get_color( $settings->progress_bar_inner_color ) ); ?>;
	}
	<?php
endif;
if ( ! empty( $settings->progress_bar_outer_color ) ) :
	...
	$progress_bar_outer_background_color = BBVapor_Modules_Pro::get_color( $progress_bar_outer_background_color );
	?>
	.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .gf_progressbar_wrapper .gf_progressbar {
		background-color: <?php echo esc_html( $progress_bar_outer_background_color ); ?>;
		-webkit-box-shadow: none;
		-moz-box-shadow: none;
		box-shadow: none;
	}
	.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .gf_progressbar_wrapper .gf_progressbar:after {
		background-color: <?php echo esc_html( $progress_bar_outer_background_color ); ?>;
		-webkit-box-shadow: none;
		-moz-box-shadow: none;
		box-shadow: none;
...
?>
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .gf_progressbar_wrapper .gf_progressbar_percentage span {
	display: inline-block;
...
?>
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .gf_page_steps .gf_step {
	height: auto;
}
<?php
if ( ! empty( $settings->progress_steps_active_background_color ) ) :
	?>
	.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .gf_page_steps .gf_step.gf_step_active,
	.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .gf_page_steps .gf_step.gf_step_completed {
		background-color: <?php echo esc_html( BBVapor_Modules_Pro::get_color( $settings->progress_steps_active_background_color ) ); ?>;
		color: <?php echo esc_html( BBVapor_Modules_Pro::get_color( $settings->progress_steps_active_text_color ) ); ?>;
	}
	<?php
endif;
if ( ! empty( $settings->progress_steps_active_border_color ) ) :
	?>
	.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .gf_page_steps .gf_step.gf_step_active, .fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .gf_page_steps .gf_step.gf_step_completed,   {
		border-color: <?php echo esc_html( BBVapor_Modules_Pro::get_color( $settings->progress_steps_active_border_color ) ); ?>;
		border-style: solid;
	}
	<?php
endif;
...
if ( ! empty( $settings->progress_steps_inactive_background_color ) ) :
	?>
	.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .gf_page_steps .gf_step.gf_step_pending,
	.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .gf_page_steps .gf_step.gf_step_completed {
		background-color: <?php echo esc_html( BBVapor_Modules_Pro::get_color( $settings->progress_steps_inactive_background_color ) ); ?>;
		color: <?php echo esc_html( BBVapor_Modules_Pro::get_color( $settings->progress_steps_inactive_text_color ) ); ?>;
	}
	<?php
endif;
if ( ! empty( $settings->progress_steps_inactive_border_color ) ) :
	...
	.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .gf_page_steps .gf_step.gf_step_pending,
	.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .gf_page_steps .gf_step.gf_step_completed {
		border-color: <?php echo esc_html( BBVapor_Modules_Pro::get_color( $settings->progress_steps_inactive_border_color ) ); ?>;
		border-style: solid;
	}
	<?php
endif;
if ( ! empty( $settings->progress_steps_inactive_opacity ) ) :
	...
	.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .gf_page_steps .gf_step.gf_step_pending,
	.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .gf_page_steps .gf_step.gf_step_completed{
		opacity: <?php echo esc_html( $settings->progress_steps_inactive_opacity ); ?>;
	}
	<?php
endif;
FLBuilderCSS::dimension_field_rule(
...
if ( ! empty( $settings->form_background_color ) ) :
	...
	$background_color = BBVapor_Modules_Pro::get_color( $background_color );
	?>
	.fl-node-<?php echo esc_html( $id ); ?> .fl-bbvm-gravityforms-for-beaverbuilder {
...
if ( ! empty( $settings->form_show_labels ) && 'no' === $settings->form_show_labels ) :
	?>
	.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .gfield .gfield_label {
		display: none;
	}
	<?php
endif;
if ( ! empty( $settings->form_show_description ) && 'no' === $settings->form_show_description ) :
	?>
	.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .ginput_container_name label
	,.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .ginput_container label,
	.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .gfield_description {
		display: none;
	}
	.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> ul.gfield_radio label,
	.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> ul.gfield_checkbox label {
		display: inline-block;
	}
	<?php
endif;
if ( ! empty( $settings->form_show_placeholders ) && 'no' === $settings->form_show_placeholders ) :
	?>
	.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .ginput_container input::-webkit-input-placeholder {
		color: transparent;
	}
...
$input_background_color = BBVapor_Modules_Pro::get_color( $input_background_color );
?>
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> input[type=text],
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> input[type=password],
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> input[type=email],
...
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> input[type=search],
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> input[type=url] {
	background: <?php echo esc_html( $input_background_color ); ?>;
	border: <?php echo absint( $settings->input_border_width ); ?>px solid <?php echo esc_html( BBVapor_Modules_Pro::get_color( $settings->input_border_color ) ); ?>;
	color: <?php echo esc_html( BBVapor_Modules_Pro::get_color( $settings->input_text_color ) ); ?>;
}
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> input[type=text],
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> input[type=password],
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> input[type=email],
...
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .gfinput_container span label::placeholder {
	...
	text-align-last: <?php echo esc_html( $settings->input_text_align ); ?>;
}
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> select {
	text-align: <?php echo esc_html( $settings->select_align ); ?>;
	text-align-last: <?php echo esc_html( $settings->select_align ); ?>;
}
<?php
FLBuilderCSS::dimension_field_rule(
	array(
...
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> input[type=url]::placeholder,
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> textarea::placeholder {
	color: <?php echo esc_html( BBVapor_Modules_Pro::get_color( $settings->placeholder_color ) ); ?>;
}
<?php
FLBuilderCSS::typography_field_rule(
	array(
...
$textarea_background_color = BBVapor_Modules_Pro::get_color( $textarea_background_color );
?>
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> textarea {
	color: <?php echo esc_html( BBVapor_Modules_Pro::get_color( $settings->textarea_color ) ); ?>;
	background: <?php echo esc_html( $textarea_background_color ); ?>;
	border-color: #<?php echo esc_html( BBVapor_Modules_Pro::get_color( $settings->textarea_border_color ) ); ?>;
...
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .gfield_radio,
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .gfield_checkbox {
	color: <?php echo esc_html( BBVapor_Modules_Pro::get_color( $settings->list_color ) ); ?>;
}
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .gfield_radio li input[type=radio],
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .gfield_checkbox li input[type=checkbox] {
	display: none;
}
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .gfield_radio label:before {
	border-radius: <?php echo absint( $settings->list_radio_radius ); ?>px;
}
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .gfield_checkbox label:before {
	border-radius: <?php echo absint( $settings->list_checkbox_radius ); ?>px;
}
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .gfield_radio label:before,
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .gfield_checkbox label:before {
	content: "";
	display: inline-block;
	vertical-align: middle;
	width: <?php echo absint( $settings->list_size ); ?>px;
	height: <?php echo absint( $settings->list_size ); ?>px;
	margin-right: 10px;
	background: <?php echo esc_html( BBVapor_Modules_Pro::get_color( $settings->list_background ) ); ?>;
	border-width: <?php echo absint( $settings->list_border ); ?>px;
	border-style: solid;
	border-color: <?php echo esc_html( BBVapor_Modules_Pro::get_color( $settings->list_border_color ) ); ?>;
	padding: 4px;
	font-size: <?php echo absint( $settings->list_size ) - 2; ?>px;
}
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .gfield_radio input[type="radio"]:checked + label::before {
	box-shadow: rgb(222, 222, 222) 0px 0px 0px 4px inset;
	background: <?php echo esc_html( BBVapor_Modules_Pro::get_color( $settings->list_selected_color ) ); ?>;
}
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .gfield_checkbox input[type="checkbox"]:checked + label::before {
	content: "";
	background: <?php echo esc_html( BBVapor_Modules_Pro::get_color( $settings->list_selected_color ) ); ?>;
	width: <?php echo absint( $settings->list_size ); ?>px;
	height: <?php echo absint( $settings->list_size ); ?>px;
}
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .gform_title, .fl-node-<?php echo esc_html( $id ); ?> .fl-bbvm-gravityforms-for-beaverbuilder .form-heading {
	color: <?php echo esc_html( BBVapor_Modules_Pro::get_color( $settings->form_title_color ) ); ?>;
}
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .gform_description, .fl-node-<?php echo esc_html( $id ); ?> .fl-bbvm-gravityforms-for-beaverbuilder .form-description {
	color: <?php echo esc_html( BBVapor_Modules_Pro::get_color( $settings->form_description_color ) ); ?>;
}
...
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> input[type=button],
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> input[type=submit],
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> button {
...
?>
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> input[type=button]:hover,
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> input[type=submit]:hover,
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> button:hover {
...
?>
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .validation_error {
	color: <?php echo esc_html( BBVapor_Modules_Pro::get_color( $settings->error_message_color ) ); ?>;
	border-top-color: <?php echo esc_html( BBVapor_Modules_Pro::get_color( $settings->error_message_color ) ); ?>;
	border-bottom-color: <?php echo esc_html( BBVapor_Modules_Pro::get_color( $settings->error_message_color ) ); ?>;
}
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> li.gfield.gfield_error {
	background: <?php echo esc_html( BBVapor_Modules_Pro::get_color( $settings->error_label_background_color ) ); ?>;
}
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .gfield_error .gfield_label, .fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> li.gfield_error div.ginput_complex.ginput_container label, .fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .gfield_description.validation_message {
...
?>
.fl-node-<?php echo esc_html( $id ); ?> #gform_confirmation_wrapper_<?php echo esc_html( $settings->form ); ?> {
	color: <?php echo esc_html( BBVapor_Modules_Pro::get_color( $settings->confirmation_color ) ); ?>;
	background: <?php echo esc_html( BBVapor_Modules_Pro::get_color( $settings->confirmation_background_color ) ); ?>;
}
