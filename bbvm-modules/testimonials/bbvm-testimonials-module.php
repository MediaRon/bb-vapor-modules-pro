 ...
 */
FLBuilder::register_module('BBVapor_Testimonials_Module', array(
	'general'       => array( // Tab
		...
		'sections'      => array( // Tab Sections
			'general'       => array( // Section
				...
				'fields'        => array( // Section Fields
					...
					'left_border' => array(
						'type' => 'unit',
						'label' => 'Left Border Separator Width', 'bb-vapor-modules-pro',
						'default' => '0',
					),
					'left_border_color' => array(
						'type' => 'color',
						'label' => 'Left Border Separator Color', 'bb-vapor-modules-pro',
						'default' => 'FFFFFF'
					),
