...
?>
.fl-node-<?php echo $id; ?> .fl-bbvm-featured-category-for-beaverbuilder {
...
.fl-node-<?php echo $id; ?> .fl-bbvm-featured-category-for-beaverbuilder:after {
	position: absolute;
	width: 100%;
	height: 100%;
	content: '';
...
.fl-node-<?php echo $id; ?> .fl-bbvm-featured-category-for-beaverbuilder:hover:after {
	background: <?php echo $background_overlay_hover; ?>;
}
.fl-node-<?php echo $id; ?> .fl-bbvm-featured-category {
	width: 100%;
	margin: 20px;
...
.fl-node-<?php echo $id; ?> .fl-bbvm-featured-category-link-wrapper {
	position: absolute;
	display: block;
	top: 0;
	left: 0;
...
if ( 'inner_border' === $settings->border_style ) {
	...
	.fl-node-<?php echo $id; ?> .fl-bbvm-featured-category-for-beaverbuilder:hover .fl-bbvm-featured-category {
		border: <?php echo absint( $settings->border_width ); ?>px solid #<?php echo esc_html( $settings->border_color_hover ); ?>;
	}
	<?php
}
?>
.fl-node-<?php echo $id; ?> .fl-bbvm-featured-category-inner {
	width: 100%;
	height: 100%;
	display: flex;
	flex-wrap: wrap;
...
.fl-node-<?php echo $id; ?> .fl-bbvm-featured-category-category {
	color: #<?php echo esc_html( $settings->category_text_color ); ?>;
}
.fl-node-<?php echo $id; ?> .fl-bbvm-featured-category-button a {
	position: absolute;
	bottom: 0;
	right: 0;
}
...
.fl-node-<?php echo $id; ?> .fl-bbvm-featured-category-button a:hover {
...
.fl-node-<?php echo $id; ?> .fl-bbvm-featured-category-for-beaverbuilder:hover .fl-bbvm-featured-category-button a {
	background: <?php echo $button_background_hover; ?>;
	color: #<?php echo $settings->button_color_hover; ?>;
	text-decoration: none;
...
?>
.fl-node-<?php echo $id; ?> .fl-bbvm-featured-category-button {
	text-align: center;
	width: 30%;
}
.fl-node-<?php echo $id; ?> .fl-bbvm-featured-category-button a {
