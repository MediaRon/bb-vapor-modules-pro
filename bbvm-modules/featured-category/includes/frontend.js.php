...
jQuery( 'body' ).on('change', '.bbvm-post-select, .bbvm-taxonomy-select', function( e ) {
		...
		jQuery.post( bbvm_beaver_builder_ajax_url, { action: 'bbvm_featured_bb_get_data', post_type: jQuery( '.bbvm-post-select :selected' ).val(), taxonomy: taxonomy, term: term }, function( response ) {
		...
		jQuery.post( bbvm_beaver_builder_ajax_url, { action: 'bbvm_featured_bb_get_terms', post_type: jQuery( '.bbvm-post-select :selected' ).val(), taxonomy: response.taxonomy }, function( response ) {
