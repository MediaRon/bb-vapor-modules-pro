...
.fl-node-<?php echo esc_html( $id ); ?> .bbvm-learndash-lessons-wrapper .ld-item-list-item-preview {
	background-color: <?php echo esc_html( BBVapor_Modules_Pro::get_color( $settings->lesson_background_color ) ); ?>;
	overflow: hidden;
}
.fl-node-<?php echo esc_html( $id ); ?> .bbvm-learndash-lessons-wrapper .ld-item-list-item-preview:hover {
	background-color: <?php echo esc_html( BBVapor_Modules_Pro::get_color( $settings->lesson_background_color_hover ) ); ?>;
}
.fl-node-<?php echo esc_html( $id ); ?> .bbvm-learndash-lessons-wrapper .learndash-wrapper .ld-item-list .ld-item-list-item .ld-item-name {
	color: <?php echo esc_html( BBVapor_Modules_Pro::get_color( $settings->lesson_anchor_color ) ); ?>;
}
.fl-node-<?php echo esc_html( $id ); ?> .bbvm-learndash-lessons-wrapper .learndash-wrapper .ld-item-list .ld-item-list-item .ld-item-name:hover {
	color: <?php echo esc_html( BBVapor_Modules_Pro::get_color( $settings->lesson_anchor_color_hover ) ); ?>;
}
<?php
...
// Grid styling.
?>
.fl-node-<?php echo esc_html( $id ); ?> .bbvm-learndash-lessons-wrapper .ld_course_grid article {
...
.fl-node-<?php echo esc_html( $id ); ?> .bbvm-learndash-lessons-wrapper .ld_course_grid article .ld-progress-bar {
...
.fl-node-<?php echo esc_html( $id ); ?> .bbvm-learndash-lessons-wrapper .ld_course_grid article .ld-progress-bar-percentage {
...
.fl-node-<?php echo esc_html( $id ); ?> .bbvm-learndash-lessons-wrapper .ld_course_grid article .ld_course_grid_button .btn {
...
.fl-node-<?php echo esc_html( $id ); ?> .bbvm-learndash-lessons-wrapper .ld_course_grid article .ld_course_grid_button .btn:hover {
...
.fl-node-<?php echo esc_html( $id ); ?> .bbvm-learndash-lessons-wrapper .ld_course_grid article .ld-progress-stats .ld-progress-percentage {
...
.fl-node-<?php echo esc_html( $id ); ?> .bbvm-learndash-lessons-wrapper .ld_course_grid article .ld-progress-steps {
...
.fl-node-<?php echo esc_html( $id ); ?> .bbvm-learndash-lessons-wrapper .ld_course_grid article .ld_course_grid_price {
...
FLBuilderCSS::border_field_rule(
	array(
		...
		'selector'     => ".fl-node-$id .bbvm-learndash-lessons-wrapper .ld_course_grid article .ld_course_grid_button .btn",
	)
);
FLBuilderCSS::border_field_rule(
	array(
		...
		'selector'     => ".fl-node-$id .bbvm-learndash-lessons-wrapper .ld_course_grid article",
	)
);
FLBuilderCSS::border_field_rule(
	array(
		...
		'selector'     => ".fl-node-$id .bbvm-learndash-lessons-wrapper .ld_course_grid article a img",
	)
);
...
FLBuilderCSS::dimension_field_rule(
	array(
		...
		'selector'     => ".fl-node-$id .bbvm-learndash-lessons-wrapper #ld_lesson_categorydropdown",
		'unit'         => 'px',
		'props'        => array(
...
FLBuilderCSS::typography_field_rule(
	array(
		...
		'selector'     => ".fl-node-$id .bbvm-learndash-lessons-wrapper .ld_course_grid article .ld_course_grid_price",
	)
);
FLBuilderCSS::typography_field_rule(
	array(
...
FLBuilderCSS::typography_field_rule(
	array(
		...
		'selector'     => ".fl-node-$id .bbvm-learndash-lessons-wrapper .ld_course_grid article .ld-progress-stats .ld-progress-percentage",
	)
);
FLBuilderCSS::typography_field_rule(
	array(
		...
		'selector'     => ".fl-node-$id .bbvm-learndash-lessons-wrapper .ld_course_grid article .ld-progress-steps",
	)
);
// Pagination Styles.
?>
<?php if ( ! empty( $settings->pager_background ) ) : ?>
.fl-node-<?php echo esc_html( $id ); ?> .bbvm-learndash-lessons-wrapper .learndash-pager {
...
.fl-node-<?php echo esc_html( $id ); ?> .bbvm-learndash-lessons-wrapper .learndash-pager,
.fl-node-<?php echo esc_html( $id ); ?> .bbvm-learndash-lessons-wrapper .learndash-pager a {
...
FLBuilderCSS::border_field_rule(
	array(
		...
		'selector'     => ".fl-node-$id .bbvm-learndash-lessons-wrapper .learndash-pager",
	)
);
FLBuilderCSS::typography_field_rule(
	array(
...
.fl-node-<?php echo esc_html( $id ); ?> .bbvm-learndash-lessons-wrapper article .entry-title {
...
FLBuilderCSS::typography_field_rule(
	array(
		...
		'selector'     => ".fl-node-$id .bbvm-learndash-lessons-wrapper article .entry-title",
	)
);
FLBuilderCSS::dimension_field_rule(
	array(
