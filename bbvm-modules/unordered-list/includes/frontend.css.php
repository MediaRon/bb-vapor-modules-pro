...
?>
.fl-node-<?php echo $id; ?> .fl-mediaron-unordered-list-for-beaverbuilder ul {
	margin: 0;
	padding: 0;
	list-style-type: none;
}
.fl-node-<?php echo $id; ?> .fl-mediaron-unordered-list-for-beaverbuilder li {
	position: relative;
	padding: 0;
	margin: 0;
	margin-left: <?php echo $settings->list_icon_size + 10; ?>px;
}
.fl-node-<?php echo $id; ?> .fl-mediaron-unordered-list-for-beaverbuilder li .icon {
	position: absolute;
...
FLBuilderCSS::typography_field_rule( array(
	...
	'selector' 	=> ".fl-node-$id .fl-mediaron-unordered-list-for-beaverbuilder li .content"
) );
endif;
...
.fl-node-<?php echo $id; ?> .fl-mediaron-unordered-list-for-beaverbuilder li:before {
	position: relative;
	content: '';
...
.fl-node-<?php echo $id; ?> .fl-mediaron-unordered-list-for-beaverbuilder li:hover:before {
...
FLBuilderCSS::typography_field_rule( array(
	'settings'	=> $settings,
	'setting_name' 	=> 'list_typography',
	'selector' 	=> ".fl-node-$id .fl-mediaron-unordered-list-for-beaverbuilder li"
) );
endif;
...
.fl-node-<?php echo $id; ?> .fl-mediaron-unordered-list-for-beaverbuilder li p {
	margin-bottom: 0;
}
.fl-node-<?php echo $id; ?> .fl-mediaron-unordered-list-for-beaverbuilder li:hover {
