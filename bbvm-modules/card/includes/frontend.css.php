...
.fl-node-<?php echo esc_html( $id ); ?> .fl-bbvm-card-for-beaverbuilder .fl-bbvm-card-icon-header .bbvm-card-icon {
	display: inline-block;
	background: <?php echo esc_html( BBVapor_Modules_Pro::get_color( $settings->icon_background ) ); ?>;
	<?php
...
.fl-node-<?php echo esc_html( $id ); ?> .fl-bbvm-card-for-beaverbuilder {
	padding: 20px 10px;
}
.fl-node-<?php echo esc_html( $id ); ?> .fl-bbvm-card-for-beaverbuilder {
	color: <?php echo esc_html( BBVapor_Modules_Pro::get_color( $settings->text_color ) ); ?>;
	border: <?php echo absint( $settings->border ); ?>px solid <?php echo esc_html( BBVapor_Modules_Pro::get_color( $settings->border_color ) ); ?>;
	box-shadow: <?php echo FLBuilderColor::shadow( $settings->text_shadow ); // phpcs:ignore ?>;
}
.fl-node-<?php echo esc_html( $id ); ?> .fl-bbvm-card-for-beaverbuilder:hover {
	color: <?php echo esc_html( BBVapor_Modules_Pro::get_color( $settings->text_color_hover ) ); ?>;
	border: <?php echo absint( $settings->border ); ?>px solid <?php echo esc_html( BBVapor_Modules_Pro::get_color( $settings->border_color_hover ) ); ?>;
	box-shadow: <?php echo FLBuilderColor::shadow( $settings->text_shadow_hover ); // phpcs:ignore ?>;
}
<?php
...
if ( 'gradient' === $settings->background_type ) :
	...
	.fl-node-<?php echo esc_html( $id ); ?> .fl-bbvm-card-for-beaverbuilder:hover {
		background-image: <?php echo FLBuilderColor::gradient( $settings->background_gradient_hover ); //phpcs:ignore ?>;
	}
	<?php
endif;
FLBuilderCSS::dimension_field_rule(
...
?>
.fl-node-<?php echo esc_html( $id ); ?> .fl-bbvm-card-for-beaverbuilder:hover .fl-bbvm-card-icon-header .bbvm-card-icon {
	background: <?php echo esc_html( BBVapor_Modules_Pro::get_color( $settings->icon_background_hover ) ); ?>;
...
?>
.fl-node-<?php echo esc_html( $id ); ?> .fl-bbvm-card-for-beaverbuilder .fl-bbvm-card-photo-header {
	text-align: center;
}
.fl-node-<?php echo esc_html( $id ); ?> .fl-bbvm-card-for-beaverbuilder .fl-bbvm-card-photo-header img.rounded {
	border-radius: 100%;
}
.fl-node-<?php echo esc_html( $id ); ?> .fl-bbvm-card-for-beaverbuilder .fl-bbvm-card-photo-header img {
	width: <?php echo absint( $settings->photo_size ); ?>px;
	height: <?php echo absint( $settings->photo_size ); ?>px;
}
.fl-node-<?php echo esc_html( $id ); ?> .fl-bbvm-card-heading {
	font-size: 18px;
	padding: 10px 20px;
	font-weight: 700;
	text-align: center;
...
?>
.fl-node-<?php echo esc_html( $id ); ?> .fl-bbvm-card-content {
	font-size: 18px;
	padding: 10px 20px;
	font-weight: 400;
	text-align: center;
...
?>
.fl-node-<?php echo esc_html( $id ); ?> .fl-bbvm-card-subheading {
	font-size: 18px;
	padding: 10px 20px;
	font-weight: 700;
	text-align: center;
...
?>
.fl-node-<?php echo esc_html( $id ); ?> .fl-bbvm-card-subheading-text {
	font-size: 18px;
	padding: 10px 20px;
	font-weight: 400;
	text-align: center;
...
?>
.fl-node-<?php echo esc_html( $id ); ?> .fl-bbvm-card-readmore a  {
	display: inline-block;
	font-size: 18px;
	padding: 10px 20px;
	font-weight: 400;
	margin: 0 auto;
	border: <?php echo absint( $settings->button_border ); ?>px solid <?php echo esc_html( BBVapor_Modules_Pro::get_color( $settings->button_border_color ) ); ?>;
}
.fl-node-<?php echo esc_html( $id ); ?> .fl-bbvm-card-for-beaverbuilder .fl-bbvm-card-readmore a,
.fl-node-<?php echo esc_html( $id ); ?> .fl-bbvm-card-for-beaverbuilder .fl-bbvm-card-readmore a:hover,
.fl-node-<?php echo esc_html( $id ); ?> .fl-bbvm-card-for-beaverbuilder .fl-bbvm-card-readmore a:visited {
	color: <?php echo esc_html( BBVapor_Modules_Pro::get_color( $settings->button_text_color ) ); ?>;
	text-decoration: none;
}
.fl-node-<?php echo esc_html( $id ); ?> .fl-bbvm-card-for-beaverbuilder a:hover {
...
if ( 'gradient' === $settings->button_background_type ) :
	?>
	.fl-node-<?php echo esc_html( $id ); ?> .fl-bbvm-card-for-beaverbuilder .fl-bbvm-card-readmore a {
		background-image: <?php echo FLBuilderColor::gradient( $settings->button_color_gradient ); // phpcs:ignore ?>;
	}
	.fl-node-<?php echo esc_html( $id ); ?> .fl-bbvm-card-for-beaverbuilder .fl-bbvm-card-readmore a:hover {
		background-image: <?php echo FLBuilderColor::gradient( $settings->button_color_gradient_hover ); //phpcs:ignore ?>;
	}
	<?php
endif;
FLBuilderCSS::typography_field_rule(
