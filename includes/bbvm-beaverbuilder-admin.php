			...
			<form action="<?php echo esc_url( add_query_arg( array( 'page' => 'bb-vapor-modules-pro' ), admin_url( 'options-general.php' ) ) ); ?>" method="POST">
				...
				<table class="form-table">
					<tbody>
						...
						<tr>
							<th scope="row"><label for="bbvm-pro"><?php esc_html_e( 'Upgrade', 'bb-vapor-modules-pro' ); ?></label>
							</th>
							<td>
								<a class="button button-secondary" href="https://bbvapormodules.com" target="_blank"><?php esc_html_e( 'Upgrade to Pro for more modules', 'bb-vapor-modules-pro' ); ?></a>
							</td>
						</tr>
					</tbody>
				</table>
